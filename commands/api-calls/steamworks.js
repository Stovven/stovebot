...
module.exports = {
  ...
  callback: async (message, arguments, text, client) => {
    ...
    if(isNaN(messageID)) {
    let vanityURL = `http://api.steampowered.com/ISteamUser/ResolveVanityURL/v0001/?key=3357D4A438D2DA9849FCDE11631CDE18&vanityurl=${messageID}`
  ...
  let steamAccountAPI = `http://api.steampowered.com/ISteamUser/GetPlayerSummaries/v0002/?key=3357D4A438D2DA9849FCDE11631CDE18&steamids=${steamID}`
  ...
  let steamAPI = `https://api.steampowered.com/IPlayerService/GetOwnedGames/v1/?key=3357D4A438D2DA9849FCDE11631CDE18&steamid=${steamID}&format=json`
